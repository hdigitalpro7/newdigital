(function ($) {
  ...
  ========================================*/
    ...
    /*services-5__active***/
    var services = new Swiper(".services-5__active", {
        slidesPerView: 1,
        spaceBetween: 30,
        loop: true,
        roundLengths: true,
    ...
    $('#getting-started').countdown('2025/01/01', function(event) {
      ...
      //   counter-5__active 
    $('#counter-5__count__active').countdown('2025/01/01', function(event) {
        $(this).html(event.strftime(' <div><span>%D</span></div>  <div><span>%H</span></div> <div><span>%M</span></div> <div><span>%S</span></div>'));
      });
    $('#header-5__count').countdown('2025/01/01', function(event) {
        $(this).html(event.strftime(' <div><span>%D</span></div>  <div><span>%H</span></div> <div><span>%M</span></div> <div><span>%S</span></div>'));
      });
